                  ...
                  <Link to="product/123">  <div className="image_box">
                    ...
                    <Link to="product/123"> 
                        ...
                        <div className="price_of_product">
                            {this.state.product.specialPrice != null && this.state.product.specialPrice? <React.Fragment><p className="para_price_one">₹ {this.state.product.price}</p>
                            <p className="para_price_two">₹ {this.state.product.specialPrice}</p></React.Fragment>:<p className="para_price_two">₹ {this.state.product.price}</p> }
