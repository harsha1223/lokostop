        ...
        return (
            ...
            <div className="individualproduct_detail_outer_box">
                ...
                <div className="details_of_individual_product_with_rating">
                    <p className="name_of_the_particular_product">LG 6.5kg 5 Star Smart Inverter Fully-Automatioc Top loading Washing Machine(T65SKSF4Z)</p>
                    <p className="category_of_that_particular_product">Washing Machines</p>
